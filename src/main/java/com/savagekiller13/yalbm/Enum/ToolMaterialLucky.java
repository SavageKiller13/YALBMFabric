...
public enum ToolMaterialLucky implements ToolMaterial {
    ...
    private ToolMaterialLucky(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
